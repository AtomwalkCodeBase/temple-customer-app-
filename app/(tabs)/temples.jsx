...
import ComingSoonMinimalScreen from "../../components/ComingSoonMinimalScreen";
...
export default function Temples() {
  ...
  //     const byLoc =
  //       !loc || t.location.toLowerCase().includes(loc.toLowerCase());
  ...
  return (
    <SafeAreaView style={styles.screen}>
      <ComingSoonMinimalScreen></ComingSoonMinimalScreen>
      {/* <Header
        type="type2"
        userName="Ashutosh"
